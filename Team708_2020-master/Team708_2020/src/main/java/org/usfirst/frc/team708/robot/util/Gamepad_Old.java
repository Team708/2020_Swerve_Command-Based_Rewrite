 ...
 */
public class Gamepad_Old extends Joystick{
    ...
    public double getAxis(int axis){
		...
		if (axis == Gamepad_Old.rightStick_Y || axis == Gamepad_Old.leftStick_Y) return -val;
		else return val;
    }
    ...
    public void sendAxesToDashboard()
    {
        SmartDashboard.putNumber("Gamepad " + port + "Right Stick X:",
        								Math708.round(getAxis(Gamepad_Old.rightStick_X),2));
        SmartDashboard.putNumber("Gamepad " + port + "Right Stick Y:",
        								Math708.round(getAxis(Gamepad_Old.rightStick_Y),2));
        SmartDashboard.putNumber("Gamepad " + port + "Left Stick X:",
                							Math708.round(getAxis(Gamepad_Old.leftStick_X),2));
        SmartDashboard.putNumber("Gamepad " + port + "Left Stick Y:",
                							Math708.round(getAxis(Gamepad_Old.leftStick_Y),2));
    }
}
